define([
    ...
    app.factory('ViewPropertiesDecFactory', [
        'alertify',
        function(alertify) {
            var Factory = {};
    ...
    app.service('ViewPropertiesDecService', [
        '$http',
        function($http) {
            var _this = this;
    ...
    app.controller('ViewPropertiesDecController', [
        '$scope',
        '$uibModalInstance',
        '$timeout',
        '$location',
        ...
        'alertify',
        'paramData',
        'ViewPropertiesDecFactory',
        'ViewPropertiesDecService',
        function($scope, $uibModalInstance, $timeout, $location, $filter, BlockUI, Alertify, paramData, Factory, Service) {
            var _init, _loadDetails, blocker = BlockUI.instances.get('blockViewPropertiesDec');
