...
class NewRequestSuManpowerServicesQueryHandler extends MakeNewRequestQueryHandler {
    public function selectSeries($specsId = false, $categoryId = false, $filter = false, $limit = false) {
        $fields = array(
        ...
        $initQuery = ($specsId) ? $initQuery->andWhere(array('MS.id' => ':id')) : $initQuery;
        $initQuery = ($categoryId) ? $initQuery->andWhere(array('MS.category_id' => ':category_id')) : $initQuery;
    ...
    public function insertNewRequestManpower($data = array())
    {
        $initQuery = $this->insert('prd_manpower_services', $data);
        return $initQuery;
    }

    public function insertNewRequestManpowerSequence($data = array())
    {
        $initQuery = $this->insert('prd_manpower_delivery_sequences', $data);
        return $initQuery;
    }

    public function insertPrdManpowerAttachments($data = array())
    {
