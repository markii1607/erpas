<?php
    ...
    class RequestTypeQueryHandler extends MakeNewRequestQueryHandler {
        ...
        public function selectProjects($id = false, $userId = false)
        {
            ...
            $joins = array(
                ...
                // 'transactions TR' => 'P.transaction_id = TR.id'
            );
            ...
            $initQuery = $this->select($fields)
                              ...
                              // ->where(array('P.is_active' => ':is_active', 'TR.status' => ':transaction_status'));
