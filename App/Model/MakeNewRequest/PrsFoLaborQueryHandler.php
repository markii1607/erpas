<?php
    ...
    class PrsFoLaborQueryHandler extends MakeNewRequestQueryHandler {
        ...
        /**
         * selectProjectMaterialDeliverySequences
         *
         * @param boolean $id
        ...
        /**
         * selectPsdLaborMobilizationPlan
         *
         * @param boolean $psd_labor_id
         * @return void
         */
        ...
        // PRS Indirect Labor Cost & Mobilization
        ...
        public function selectLaborCost($project_id = false, $id = false)
        {
            $fields = array(
                ...
                'LC.total_man_days',
                '"saved" as data_status',
                'CONCAT(P.code, " - ", P.name) as position_name'

            );

            $joins =  array(
                'positions P'       => 'LC.position_id = P.id'
            );
        ...
        {
            $initQuery = $this->insert('prl_work_items', $data);
            return $initQuery;
        }

        public function insertPrLaborAttachments($data = array())
        {
            $initQuery = $this->insert('pr_labor_attachments', $data);
            return $initQuery;
        }

        public function insertPrLaborIndirects($data = array())
        {
            $initQuery = $this->insert('pr_labor_indirects', $data);
            return $initQuery;
        }
