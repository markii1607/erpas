...
class AddItemHeavyEquipmentQueryHandler extends MakeNewRequestQueryHandler
{
    ...
    public function selectPsdEquipments($id = false, $psSwiDirectId = false)
    {
        ...
        $initQuery = $initQuery->andWhere(['ET.classification' => '"HE"']);
    ...
    {
        $initQuery = $this->insert('pr_heavy_equipments', $data);
    ...
    {
        $initQuery = $this->insert('pr_heavy_work_items', $data);
    ...
    public function insertHeavyEquipmentAttachments($data = array())
    {
        $initQuery = $this->insert('pr_heavy_equipment_attachments', $data);
        return $initQuery;
    }
}
