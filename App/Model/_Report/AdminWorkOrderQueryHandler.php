<?php 
    ...
    class AdminWorkOrderQueryHandler extends QueryHandler {
        ...
        /**
         * `selectAdminWorkOrders` Query string that will fetch from table `admin_work_orders`.
         * @param  boolean $id
        ...
        public function selectAdminWorkOrders($id = false, $transactionId = false)
        {
            $fields = [
                ...
                'AWO.description',
                'AWO.created_by',
                'AWO.updated_at as date_revised',
                // 'CONCAT(E.fname, " ",E.mname, " ",E.fname) as project_manager',
            ];

            $leftJoins = [
                'transactions T' => 'T.id = AWO.transaction_id',
                'users U'        => 'AWO.created_by = U.id',
