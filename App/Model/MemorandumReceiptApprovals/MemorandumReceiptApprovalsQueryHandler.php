...
namespace App\Model\MemorandumReceiptApprovals;

require_once('../../AbstractClass/QueryHandler.php');

use App\AbstractClass\QueryHandler;

class MemorandumReceiptApprovalsQueryHandler extends QueryHandler {
    ...
    public function selectMemorandumReceipts($id = false)
    {
        ...
        $initQuery = $this->select($fields)
                          ...
                          ->where(['MR.is_active' => ':is_active', 'MR.signatory_id' => ':signatory']);
