<?php
    require_once('../../Controller/UserAccessConfiguration/ProjectAccessController.php');
    require_once('../../Config/db_connection.php');

    use App\Controller\UserAccessConfiguration\ProjectAccessController;
    ...
    function functionHandler() {
        ...
        $controller = new ProjectAccessController(connectToDb());
