<?php
    require_once('../../Controller/UserAccessConfiguration/AddDeputyController.php');
    require_once('../../Config/db_connection.php');

    use App\Controller\UserAccessConfiguration\AddDeputyController;
    ...
    function functionHandler() {
        ...
        $controller = new AddDeputyController(connectToDb());
