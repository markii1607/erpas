<?php
    require_once('../../Controller/UserAccessConfiguration/AccessController.php');
    require_once('../../Config/db_connection.php');

    use App\Controller\UserAccessConfiguration\AccessController;
    ...
    function functionHandler() {
        ...
        $controller = new AccessController(connectToDb());
