<?php
    require_once('../../Controller/UserAccessConfiguration/ViewAccessController.php');
    require_once('../../Config/db_connection.php');

    use App\Controller\UserAccessConfiguration\ViewAccessController;
    ...
    function functionHandler() {
        ...
        $controller = new ViewAccessController(connectToDb());
