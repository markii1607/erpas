<?php
    require_once('../../Controller/UserAccessConfiguration/ViewProjectAccessesController.php');
    require_once('../../Config/db_connection.php');

    use App\Controller\UserAccessConfiguration\ViewProjectAccessesController;
    ...
    function functionHandler() {
        ...
        $controller = new ViewProjectAccessesController(connectToDb());
