<?php
    require_once('../../Controller/UserAccessConfiguration/ViewDeputyConfigController.php');
    require_once('../../Config/db_connection.php');

    use App\Controller\UserAccessConfiguration\ViewDeputyConfigController;
    ...
    function functionHandler() {
        ...
        $controller = new ViewDeputyConfigController(connectToDb());
