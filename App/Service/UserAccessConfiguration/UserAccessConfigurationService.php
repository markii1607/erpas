<?php
    require_once('../../Controller/UserAccessConfiguration/UserAccessConfigurationController.php');
    require_once('../../Config/db_connection.php');
    
    use App\Controller\UserAccessConfiguration\UserAccessConfigurationController;
    ...
    function functionHandler() {
        ...
        $controller = new UserAccessConfigurationController(connectToDb());
