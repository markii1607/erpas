<?php
    require_once('../../Controller/MarketValueSubclassification/MarketValueSubclassificationController.php');
    require_once('../../Config/db_connection.php');
    
    use App\Controller\MarketValueSubclassification\MarketValueSubclassificationController;
    ...
    function functionHandler() {
        ...
        $controller = new MarketValueSubclassificationController(connectToDb());
