<?php
    require_once('../../Controller/QrAssessmentReport/QrAssessmentReportController.php');
    require_once('../../Config/db_connection.php');
    
    use App\Controller\QrAssessmentReport\QrAssessmentReportController;
    ...
    function functionHandler() {
        ...
        $controller = new QrAssessmentReportController(connectToDb());
