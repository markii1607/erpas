<?php
    require_once('../../Controller/Main/EmploymentHistoryController.php');
    require_once('../../Config/db_connection.php');

    use App\Controller\Main\EmploymentHistoryController;
    ...
    function functionHandler() {
        ...
        $controller = new EmploymentHistoryController(connectToDb());
