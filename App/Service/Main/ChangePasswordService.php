<?php
    require_once('../../Controller/Main/ChangePasswordController.php');
    require_once('../../Config/db_connection.php');

    use App\Controller\Main\ChangePasswordController;
    ...
    function functionHandler() {
        ...
        $controller = new ChangePasswordController(connectToDb());
