<?php
    require_once('../../Controller/Main/EducationalBackgroundController.php');
    require_once('../../Config/db_connection.php');

    use App\Controller\Main\EducationalBackgroundController;
    ...
    function functionHandler() {
        ...
        $controller = new EducationalBackgroundController(connectToDb());
