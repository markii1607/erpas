<?php
    require_once('../../Controller/Login/RegistrationController.php');
    require_once('../../Config/db_connection.php');
    
    use App\Controller\Login\RegistrationController;
    ...
    function functionHandler() {
        ...
        $controller = new RegistrationController(connectToDb());
