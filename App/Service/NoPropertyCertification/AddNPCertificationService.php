<?php
    require_once('../../Controller/NoPropertyCertification/AddNPCertificationController.php');
    require_once('../../Config/db_connection.php');

    use App\Controller\NoPropertyCertification\AddNPCertificationController;
    ...
    function functionHandler() {
        ...
        $controller = new AddNPCertificationController(connectToDb());
