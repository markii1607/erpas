<?php
    require_once('../../Controller/NoPropertyCertification/NoPropertyCertificationController.php');
    require_once('../../Config/db_connection.php');
    
    use App\Controller\NoPropertyCertification\NoPropertyCertificationController;
    ...
    function functionHandler() {
        ...
        $controller = new NoPropertyCertificationController(connectToDb());
