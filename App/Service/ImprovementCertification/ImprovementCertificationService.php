<?php
    require_once('../../Controller/ImprovementCertification/ImprovementCertificationController.php');
    require_once('../../Config/db_connection.php');
    
    use App\Controller\ImprovementCertification\ImprovementCertificationController;
    ...
    function functionHandler() {
        ...
        $controller = new ImprovementCertificationController(connectToDb());
