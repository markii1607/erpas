<?php
    require_once('../../Controller/MarketValueRevision/AddRevisionYearController.php');
    require_once('../../Config/db_connection.php');

    use App\Controller\MarketValueRevision\AddRevisionYearController;
    ...
    function functionHandler() {
        ...
        $controller = new AddRevisionYearController(connectToDb());
