<?php
    require_once('../../Controller/MarketValueRevision/MarketValueRevisionController.php');
    require_once('../../Config/db_connection.php');
    
    use App\Controller\MarketValueRevision\MarketValueRevisionController;
    ...
    function functionHandler() {
        ...
        $controller = new MarketValueRevisionController(connectToDb());
