<?php
    require_once('../../Controller/MarketValueClassification/MarketValueClassificationController.php');
    require_once('../../Config/db_connection.php');
    
    use App\Controller\MarketValueClassification\MarketValueClassificationController;
    ...
    function functionHandler() {
        ...
        $controller = new MarketValueClassificationController(connectToDb());
