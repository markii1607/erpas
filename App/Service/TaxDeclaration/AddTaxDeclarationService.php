<?php
    require_once('../../Controller/TaxDeclaration/AddTaxDeclarationController.php');
    require_once('../../Config/db_connection.php');

    use App\Controller\TaxDeclaration\AddTaxDeclarationController;
    ...
    function functionHandler() {
        ...
        $controller = new AddTaxDeclarationController(connectToDb());
