<?php
    require_once('../../Controller/TaxDeclaration/EditTaxDeclarationController.php');
    require_once('../../Config/db_connection.php');

    use App\Controller\TaxDeclaration\EditTaxDeclarationController;
    ...
    function functionHandler() {
        ...
        $controller = new EditTaxDeclarationController(connectToDb());
