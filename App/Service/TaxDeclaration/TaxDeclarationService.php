<?php
    require_once('../../Controller/TaxDeclaration/TaxDeclarationController.php');
    require_once('../../Config/db_connection.php');
    
    use App\Controller\TaxDeclaration\TaxDeclarationController;
    ...
    function functionHandler() {
        ...
        $controller = new TaxDeclarationController(connectToDb());
