<?php
    require_once('../../Controller/BarangaysConfig/BarangaysConfigController.php');
    require_once('../../Config/db_connection.php');
    
    use App\Controller\BarangaysConfig\BarangaysConfigController;
    ...
    function functionHandler() {
        ...
        $controller = new BarangaysConfigController(connectToDb());
