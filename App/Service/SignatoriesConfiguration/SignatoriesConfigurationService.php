<?php
    require_once('../../Controller/SignatoriesConfiguration/SignatoriesConfigurationController.php');
    require_once('../../Config/db_connection.php');
    
    use App\Controller\SignatoriesConfiguration\SignatoriesConfigurationController;
    ...
    function functionHandler() {
        ...
        $controller = new SignatoriesConfigurationController(connectToDb());
