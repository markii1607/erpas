<?php
    require_once('../../Controller/TreasurerTdMonitoring/AddTDPaymentController.php');
    require_once('../../Config/db_connection.php');

    use App\Controller\TreasurerTdMonitoring\AddTDPaymentController;
    ...
    function functionHandler() {
        ...
        $controller = new AddTDPaymentController(connectToDb());
