<?php
    require_once('../../Controller/TreasurerTdMonitoring/TreasurerTdMonitoringController.php');
    require_once('../../Config/db_connection.php');
    
    use App\Controller\TreasurerTdMonitoring\TreasurerTdMonitoringController;
    ...
    function functionHandler() {
        ...
        $controller = new TreasurerTdMonitoringController(connectToDb());
