<?php
    require_once('../../Controller/PropertiesDec/PropertiesDecController.php');
    require_once('../../Config/db_connection.php');
    
    use App\Controller\PropertiesDec\PropertiesDecController;
    ...
    function functionHandler() {
        ...
        $controller = new PropertiesDecController(connectToDb());
