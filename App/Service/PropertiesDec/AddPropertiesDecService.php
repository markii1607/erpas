<?php
    require_once('../../Controller/PropertiesDec/AddPropertiesDecController.php');
    require_once('../../Config/db_connection.php');

    use App\Controller\PropertiesDec\AddPropertiesDecController;
    ...
    function functionHandler() {
        ...
        $controller = new AddPropertiesDecController(connectToDb());
