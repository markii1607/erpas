<?php
    ...
    class EducationalBackgroundController extends SubModuleController {
        ...
        /**
         * `saveEducationalBackgroundDetails` Save new `attainment_levels`, `schools` and `courses`.
         * @param object $input
         * @return  void
         */
        public function saveEducationalBackgroundDetails($input)
        {
            $return = [
                'status' => true
            ];
